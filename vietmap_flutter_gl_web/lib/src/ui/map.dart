...
import 'package:vietmap_flutter_gl_web/src/style/layers/layer.dart';
import 'package:vietmap_flutter_gl_web/src/style/sources/geojson_source.dart';
import 'package:vietmap_flutter_gl_web/src/style/sources/source.dart';
import 'package:vietmap_flutter_gl_web/src/style/sources/vector_source.dart';
import 'package:vietmap_flutter_gl_web/src/style/style.dart';
import 'package:vietmap_flutter_gl_web/src/ui/camera.dart';
import 'package:vietmap_flutter_gl_web/src/ui/handler/box_zoom.dart';
import 'package:vietmap_flutter_gl_web/src/ui/handler/dblclick_zoom.dart';
import 'package:vietmap_flutter_gl_web/src/ui/handler/drag_pan.dart';
import 'package:vietmap_flutter_gl_web/src/ui/handler/drag_rotate.dart';
import 'package:vietmap_flutter_gl_web/src/ui/handler/keyboard.dart';
import 'package:vietmap_flutter_gl_web/src/ui/handler/scroll_zoom.dart';
import 'package:vietmap_flutter_gl_web/src/ui/handler/touch_zoom_rotate.dart';

///  The `VietmapGL` object represents the map on your page. It exposes methods
...
class VietmapGL extends Camera {
  @override
  final VietmapGLJsImpl jsObject;

  factory VietmapGL(MapOptions options) =>
      VietmapGL.fromJsObject(VietmapGLJsImpl(options.jsObject));
  ...
  VietmapGL addControl(dynamic control, [String? position]) {
    if (position != null) {
      return VietmapGL.fromJsObject(
          jsObject.addControl(control.jsObject, position));
    }
    return VietmapGL.fromJsObject(jsObject.addControl(control.jsObject));
  }
  ...
  VietmapGL removeControl(dynamic control) =>
      VietmapGL.fromJsObject(jsObject.removeControl(control.jsObject));
  ...
  VietmapGL resize([dynamic eventData]) =>
      VietmapGL.fromJsObject(jsObject.resize());
  ...
  VietmapGL setMaxBounds(LngLatBounds? bounds) =>
      VietmapGL.fromJsObject(jsObject.setMaxBounds(bounds?.jsObject));
  ...
  VietmapGL setMinZoom([num? minZoom]) =>
      VietmapGL.fromJsObject(jsObject.setMinZoom(minZoom));
  ...
  VietmapGL setMaxZoom([num? maxZoom]) =>
      VietmapGL.fromJsObject(jsObject.setMaxZoom(maxZoom));
  ...
  ///  @returns {VietmapGL} `this`
  VietmapGL setMinPitch([num? minPitch]) =>
      VietmapGL.fromJsObject(jsObject.setMinPitch());
  ...
  ///  @returns {VietmapGL} `this`
  VietmapGL setMaxPitch([num? maxPitch]) =>
      VietmapGL.fromJsObject(jsObject.setMaxPitch());
  ...
  ///  @see [Render world copies](https://maplibre.org/maplibre-gl-js/docs/examples/render-world-copies/)
  VietmapGL setRenderWorldCopies([bool? renderWorldCopies]) =>
      VietmapGL.fromJsObject(jsObject.setRenderWorldCopies(renderWorldCopies));
  ...
  // VietmapGL on(String type, [dynamic layerIdOrListener, Listener listener]);

  ///  Removes an event listener for layer-specific events previously added with `VietmapGL#on`.
  ///
  ...
  ///  @returns {VietmapGL} `this`
  // Defined in evented.dart
  // VietmapGL off(String type, [dynamic layerIdOrListener, Listener listener]);
  ...
  ///  Omitting this parameter (i.e. calling [VietmapGL.queryRenderedFeatures] with zero arguments,
  ...
  ///  [Feature objects](https://tools.ietf.org/html/rfc7946#section-3.2).
  ///
  ///  In contrast to [VietmapGL.queryRenderedFeatures], this function returns all features matching the query parameters,
  ...
  VietmapGL addSource(String id, dynamic source) {
    if (source is Source) {
      return VietmapGL.fromJsObject(jsObject.addSource(id, source.jsObject));
    }
    return VietmapGL.fromJsObject(jsObject.addSource(id, jsify(source)));
  }
  ...
  ///  Load an image from an external URL to be used with `VietmapGL#addImage`. External
  ...
  VietmapGL addLayer(dynamic layer, [String? beforeId]) {
    if (layer is Layer) {
      return VietmapGL.fromJsObject(
          jsObject.addLayer(layer.jsObject, beforeId));
    }
    return VietmapGL.fromJsObject(jsObject.addLayer(jsify(layer), beforeId));
  }
  ...
  VietmapGL moveLayer(String id, String beforeId) =>
      VietmapGL.fromJsObject(jsObject.moveLayer(id, beforeId));
  ...
  VietmapGL setLayerZoomRange(String layerId, num minzoom, num maxzoom) =>
  ...
  VietmapGL setFilter(String layerId, dynamic filter,
          [StyleSetterOptions? options]) =>
      VietmapGL.fromJsObject(jsObject.setFilter(layerId, filter));
  ...
  VietmapGL setLayoutProperty(String layerId, String name, dynamic value,
          [StyleSetterOptions? options]) =>
      VietmapGL.fromJsObject(jsObject.setLayoutProperty(layerId, name, value));
  ...
  ///  [VietmapGL.queryRenderedFeatures] or event handlers can be used as feature identifiers.
  ...
  ///  Feature objects returned from [VietmapGL.queryRenderedFeatures] or event handlers can be used as feature identifiers.
  ...
  /// Creates a new VietmapGL from a [jsObject].
  VietmapGL.fromJsObject(this.jsObject) : super.fromJsObject(jsObject);
}
...
class MapOptions extends JsObjectWrapper<MapOptionsJsImpl> {
  ...
  /// A callback run before the VietmapGL makes a request for an external URL. The callback can be used to modify the url, set headers, or set the credentials property for cross-origin requests.
...
///
///   @override
///   HtmlElement onAdd(VietmapGL map) {
...
class IControl extends JsObjectWrapper<IControlJsImpl> {
  ...
  ///  and resources. This method is called by {@link VietmapGL#addControl}
  ///  internally.
  HtmlElement onAdd(VietmapGL map) => jsObject.onAdd(map.jsObject);

  ///  Unregister a control on the map and give it a chance to detach event listeners
  ///  and resources. This method is called by {@link VietmapGL#removeControl}
  ///  internally.
  onRemove(VietmapGL map) => jsObject.onRemove(map.jsObject);

  ///  Optionally provide a default position for this control. If this method
  ///  is implemented and {@link VietmapGL#addControl} is called without the `position`
