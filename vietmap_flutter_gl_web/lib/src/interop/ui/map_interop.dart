@JS('vietmapgl')
library vietmap.interop.ui.map;

import 'dart:html';
import 'package:js/js.dart';
import 'package:vietmap_flutter_gl_web/src/interop/geo/geojson_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/geo/lng_lat_bounds_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/geo/lng_lat_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/geo/point_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/style/style_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/ui/camera_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/ui/handler/box_zoom_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/ui/handler/dblclick_zoom_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/ui/handler/drag_pan_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/ui/handler/drag_rotate_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/ui/handler/keyboard_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/ui/handler/scroll_zoom_interop.dart';
import 'package:vietmap_flutter_gl_web/src/interop/ui/handler/touch_zoom_rotate_interop.dart';
...
@JS('Map')
class VietmapGLJsImpl extends CameraJsImpl {
  external factory VietmapGLJsImpl(MapOptionsJsImpl options);
  ...
  external VietmapGLJsImpl addControl(IControlJsImpl? control,
      [String? position]);
  ...
  external VietmapGLJsImpl removeControl(IControlJsImpl? control);
  ...
  external VietmapGLJsImpl resize([dynamic eventData]);
  ...
  external VietmapGLJsImpl setMaxBounds(LngLatBoundsJsImpl? bounds);
  ...
  external VietmapGLJsImpl setMinZoom([num? minZoom]);
  ...
  external VietmapGLJsImpl setMaxZoom([num? maxZoom]);
  ...
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl setMinPitch([num? minPitch]);
  ...
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl setMaxPitch([num? maxPitch]);
  ...
  ///  @see [Render world copies](https://maplibre.org/maplibre-gl-js/docs/examples/render-world-copies/)
  external VietmapGLJsImpl setRenderWorldCopies([bool? renderWorldCopies]);
  ...
  //external VietmapGL on(String type, [dynamic layerIdOrListener, Listener listener]);
  ...
  ///  @returns {VietmapGL} `this`
  // Defined in evented.dart
  //external VietmapGL off(String type, [dynamic layerIdOrListener, Listener listener]);
  ...
  external VietmapGLJsImpl setStyle(dynamic style, [dynamic options]);
  ...
  external VietmapGLJsImpl addSource(String id, dynamic source);
  ...
  external VietmapGLJsImpl addLayer(dynamic layer, [String? beforeId]);
  ...
  external VietmapGLJsImpl moveLayer(String id, String beforeId);
  ...
  external VietmapGLJsImpl setLayerZoomRange(
  ...
  external VietmapGLJsImpl setFilter(String layerId, dynamic filter,
  ...
  external VietmapGLJsImpl setLayoutProperty(
  ...
  ///  @param {boolean} [options.validate=true] Whether to check if the filter conforms to the VietmapGL JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl setLight(
...
abstract class IControlJsImpl {
  ...
  ///  internally.
  external HtmlElement onAdd(VietmapGLJsImpl map);

  ///  Unregister a control on the map and give it a chance to detach event listeners
  ///  and resources. This method is called by {@link VietmapGL#removeControl}
  ///  internally.
  external onRemove(VietmapGLJsImpl map);
