@JS('vietmapgl')
library vietmap.interop.ui.camera;
...
import 'package:vietmap_flutter_gl_web/src/interop/util/evented_interop.dart';
...
abstract class CameraJsImpl extends EventedJsImpl {
  ...
  ///  @example
  ///  map.setCenter([-74, 38]);
  external VietmapGLJsImpl setCenter(LngLatJsImpl center, [dynamic eventData]);
  ...
  external VietmapGLJsImpl panBy(PointJsImpl offset,
  ...
  ///  @fires moveend
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl panTo(LngLatJsImpl lnglat,
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  // zoom the map to 5
  ///  map.setZoom(5);
  external VietmapGLJsImpl setZoom(num zoom, [dynamic eventData]);
  ...
  ///  @fires zoomend
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl zoomTo(num zoom,
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires zoomend
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl zoomIn(
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires zoomend
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl zoomOut(
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  map.setBearing(90);
  external VietmapGLJsImpl setBearing(num bearing, [dynamic eventData]);
  ...
  ///  @fires moveend
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl rotateTo(num bearing,
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires moveend
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl resetNorth(
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires moveend
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl resetNorthPitch(
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires moveend
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl snapToNorth(
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires moveend
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl setPitch(num pitch, [dynamic eventData]);
  ...
  external VietmapGLJsImpl fitBounds(LngLatBoundsJsImpl bounds,
  ...
  external VietmapGLJsImpl fitScreenCoordinates(
  ...
  ///  @fires pitchend
  ///  @returns {VietmapGL} `this`
  external VietmapGLJsImpl jumpTo(CameraOptionsJsImpl options,
      [dynamic eventData]);
  ...
  ///  @returns {VietmapGL} `this`
  ///  @see [Navigate the map with game-like controls](https://maplibre.org/maplibre-gl-js/docs/examples/game-controls/)
  external VietmapGLJsImpl easeTo(dynamic options, [dynamic eventData]);
  ...
  external VietmapGLJsImpl flyTo(dynamic options, [dynamic eventData]);
