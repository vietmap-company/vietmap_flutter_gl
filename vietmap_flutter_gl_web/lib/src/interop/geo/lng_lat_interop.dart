@JS('vietmapgl')
library vietmap.interop.geo.lng_lat;
...
///
///  VietmapGL JS uses longitude, latitude coordinate order (as opposed to latitude, longitude) to match GeoJSON.
///
///  Note that any VietmapGL JS method that accepts a `LngLat` object as an argument or option
...
///  @example
///  var ll = new LngLat(-73.9749, 40.7736);
...
class LngLatJsImpl {
  ...
  ///  @example
  ///  var ll = new LngLat(286.0251, 40.7736);
  ///  var wrapped = ll.wrap();
  ///  wrapped.lng; // = -73.9749
