@JS('vietmapgl')
library vietmap.interop.util.evented;
...
abstract class EventedJsImpl {
  ...
  external VietmapGLJsImpl on(String type,
  ...
  external VietmapGLJsImpl off(String type,
      [dynamic layerIdOrListener, ListenerJsImpl? listener]);
  ...
  ///  @returns {Object} `this`
  external VietmapGLJsImpl once(String type, ListenerJsImpl listener);
