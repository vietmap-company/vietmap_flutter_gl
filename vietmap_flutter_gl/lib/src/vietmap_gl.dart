...
class VietmapGL extends StatefulWidget {
  ...
  /// Set `VietmapGL.useHybridComposition` to `false` in order use Virtual-Display
...
/// Configuration options for the VietmapGL user interface.
///
...
class _VietmapOptions {
  ...
  _VietmapOptions.fromWidget(VietmapGL map)
      : this(
