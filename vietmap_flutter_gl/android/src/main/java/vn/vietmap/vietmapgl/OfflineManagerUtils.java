...
import vn.vietmap.android.offline.OfflineRegion;
import vn.vietmap.android.offline.OfflineRegionDefinition;
import vn.vietmap.android.offline.OfflineRegionError;
import vn.vietmap.android.offline.OfflineRegionStatus;
import vn.vietmap.android.offline.OfflineTilePyramidRegionDefinition;
                ...
                OfflineRegion.OfflineRegionObserver observer =
                    new OfflineRegion.OfflineRegionObserver() {
                      ...
                      public void mapboxTileCountLimitExceeded(long limit) {
                        Log.e(TAG, "VietMap tile count" + " limit exceeded: " + limit);
                        // Reset downloading state
                        _offlineRegion.setDownloadState(OfflineRegion.STATE_INACTIVE);
                        isComplete.set(true);
                        channelHandler.onError(
